...
class Html
{
    ...
    use
    Components\ButtonTrait,
    Components\CheckboxTrait,
    Components\DivTrait,
    Components\HyperlinkTrait,
    Components\LiTrait,
    Components\RadioTrait,
    Components\SelectTrait,
    Components\SpanTrait,
    Components\TextboxTrait,
    Components\ViewTrait;
